import numpy as np
import cv2
from colmap_utils import run_colmap, compute_scale_factor, apply_scale_factor
from general_utils import filter_poses, read_poses, compute_relative_motions
...
if __name__ == "__main__":
    ...
    R_X, t_X = cv2.calibrateHandEye(R_A, t_A, R_B, t_B, method=cv2.CALIB_HAND_EYE_PARK)
